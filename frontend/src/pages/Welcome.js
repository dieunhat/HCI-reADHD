...
function WelcomePage() {
  ...
  return (
    <>
	  ...
	  <Header/>
        <main
          className="flex-1 overflow-y-auto p-5 max-w-screen-2xl min-w-lg mx-auto"
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-1 px-5">
              ...
              <div
                className={"min-w-fit max-w-screen-xl w-[48rem] h-full mt-8"}
              >
                {currentButtonAddText ? (
                  <TextareaAutosize
        ...
        <footer className="footer items-center p-4">
          <aside className="items-center grid-flow-col">
            ...
            <p><Logo/> - Human Computer Interaction project by Group 4</p>
          </aside>
