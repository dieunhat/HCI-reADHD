...
function ReadingPage() {
  ...
  return (
    <div className="mx-auto mb-5 h-fit">
      <TitleCard
        id="doc"
        title={<p className="text-success">{contentTitle}</p>}
        TopSideButtons={"Bionic Mode"}
      >
        <div
          className="card-body max-h-[26rem] text-justify w-full h-[26rem] py-1
        ...
        >
          <button className="btn btn-success btn-outline btn-sm w-64 mx-auto">
            Upload New Text
          </button>
        </Link>
      </TitleCard>
