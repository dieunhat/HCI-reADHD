...
function ReadingTools() {
    ...
    return (
        <div className="w-full col-span-2">
            <div
                className="join join-vertical h-max w-max float-right items-right
            ...
            >
                ...
                >
                    <div className="flex flex-row items-center gap-1 w-full">
                        ...
                        <span className="max-lg:hidden">Save Document</span>
                    </div>
                </button>
                <button
                    id="summary-button"
